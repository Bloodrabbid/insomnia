...
10. **Tab Actions (Move/Rename)**: Возможность быстро переместить запрос в любую папку коллекции или переименовать его прямо из контекстного меню вкладки, не используя боковую панель.
...
- **Перемещение из вкладок**: `packages/insomnia/src/ui/components/modals/move-request-modal.tsx`
  *(Интерфейс выбора папки для переноса запроса из меню вкладки)*
